...
class MedicalRAGSystem:
    ...
    def add_patient_note(
        self, note_text: str, patient_id: str, note_metadata: dict[str, Any] = None
    ):
        """
        환자 노트를 시스템에 추가
    ...
    def get_relevant_medical_context(self, query: str, k: int = 5):
        ...
        for i, result in enumerate(results):
            ...
            context_parts.append(f"[참고 {i + 1} - {category}]\n{content}")
...
if __name__ == "__main__":
    ...
    # 테스트
    print("\n=== ChromaDB 검색 테스트 ===")
    test_queries = ["고혈압 치료 방법", "당뇨병 관리", "폐렴 진단 기준"]
    ...
    rag_system.add_patient_note(
        ...
        patient_id="P12345",
        note_metadata={"date": "2024-01-15", "doctor": "김의사"},
    )
