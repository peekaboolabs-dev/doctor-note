...
# 테스트할 모델 목록
MODELS = ["solar", "gpt-oss:20b", "gemma3:12b", "gemma3:27b", "qwen3:8b", "qwen3:30b"]
...
def create_comparison_report():
    ...
    comparison = {"generated_at": datetime.now().isoformat(), "models": {}}
    ...
    for file_path in benchmark_files:
        ...
        # 해당 모델의 최신 결과인지 확인
        if (
            model_name not in model_latest
            or timestamp > model_latest[model_name]["timestamp"]
        ):
